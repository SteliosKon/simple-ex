  ...
  return (
    <svg width='12' height='12' viewBox='0 0 12 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M8 1V3' stroke='#253866' strokeWidth='0.5' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M4 1V3' stroke='#253866' strokeWidth='0.5' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M1.5 5H10.5' stroke='#253866' strokeWidth='0.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  )
}
