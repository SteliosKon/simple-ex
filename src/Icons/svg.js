export const EmailIcon = () => {
  return (
    <svg width='12' height='12' viewBox='0 0 12 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <rect x='1.25' y='2.25' width='9.5' height='7.5' rx='0.75' stroke='#253766' strokeWidth='0.5' />
      <path
...
export const DateIcon = () => {
  return (
    <svg width='12' height='12' viewBox='0 0 12 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      />
      <path d='M8 1V3' stroke='#253866' stroke-width='0.5' stroke-linecap='round' stroke-linejoin='round' />
      <path d='M4 1V3' stroke='#253866' stroke-width='0.5' stroke-linecap='round' stroke-linejoin='round' />
      <path d='M1.5 5H10.5' stroke='#253866' stroke-width='0.5' stroke-linecap='round' stroke-linejoin='round' />
    </svg>
  )
}
